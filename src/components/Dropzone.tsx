...
export default function Dropzone() {
  ...
  async function handleFile(file: File | null | undefined) {
    ...
    try {
      const data = await parseKarinFile(file)
      useKarin.getState().setData(data)
    } catch (err) {
    ...
    <div className="relative flex h-dvh items-center justify-center bg-neutral-50 px-4 py-8 text-neutral-900 dark:bg-neutral-950 dark:text-neutral-100">
      ...
      <div className="w-full max-w-xl">
        ...
        >
          ...
          <p className="text-sm text-neutral-900 dark:text-neutral-100">Drop your karin-data.js here</p>
          <button
            type="button"
